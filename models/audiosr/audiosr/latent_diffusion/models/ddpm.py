...
class DDPM(nn.Module):
    ...
    def register_schedule(
        ...
        self.register_buffer(
            "sqrt_recip_alphas_cumprod", to_torch(np.sqrt(1.0 / np.clip(alphas_cumprod + epsilon, 1e-20, None)))
        )
        self.register_buffer(
            "sqrt_recipm1_alphas_cumprod", to_torch(np.sqrt(np.clip(1.0 / np.clip(alphas_cumprod + epsilon, 1e-20, None) - 1, 1e-20, None)))
        )
