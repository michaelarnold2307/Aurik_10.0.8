...
Tier 2-5: Phasen 01–56 (jede via PerPhaseMusicalGoalsGate)
...
|---|---|---|
| Guitar / Electric Guitar | `phase_44` | >= 0.6 |
| Brass / Trumpet / Saxophone | `phase_45` | >= 0.6 |
| Drum / Percussion | `phase_51` | >= 0.5 |
| Piano / Keyboard | `phase_52` | >= 0.6 |
...
| `print_through` | phase_29, phase_24, phase_03, phase_23 |
...
REGRESSION_THRESHOLD ist restorability-adaptiv:
- restorability >= 70: 0.012
- restorability 40-69: 0.040
- restorability < 40:  0.060
