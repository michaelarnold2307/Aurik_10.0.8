...
class TestQueueWidgetDragDrop:
    ...
    def _make_widget(self):
        """Erstellt ein QueueWidget ohne echtes Qt-Hauptfenster."""
        import os
        import sys
    ...
    def test_add_item_sets_user_role_in_source(self):
        ...
        assert "setData" in src and "Qt.UserRole" in src, "setData(UserRole) fehlt!"
    ...
    def test_on_rows_moved_source_emits_reorder_requested(self):
        ...
        assert "reorder_requested.emit" in src, "_on_rows_moved ruft reorder_requested.emit() nicht auf!"
    ...
    def test_queue_list_internal_move_in_source(self):
        ...
        assert "setDragDropMode" in src, "setDragDropMode fehlt!"
